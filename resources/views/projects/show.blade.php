            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr><th>Client</th><td>{{ $project->client->first_name or '' }}</td></tr>
                        ...
                        <tr><th>Project status</th><td>{{ $project->project_status->title or '' }}</td></tr>
                        <tr><th>Webhook</th><td>{{ $project->webhook }}</td></tr>
                    </table>
                </div>
            </div>
